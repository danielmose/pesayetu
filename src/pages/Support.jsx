...
import { ArrowLeft, Send, MessageCircle, Plus, ChevronRight } from 'lucide-react';
        ...
        {showNewTicket && (
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button onClick={() => { setShowNewTicket(false); setNewSubject(''); }}
                className="btn-secondary" style={{ flex: 1 }}>Cancel</button>
              <button onClick={createTicket} disabled={sending || !newSubject.trim()}
            ...
            {tickets.map(ticket => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 11, color: statusColor(ticket.status) }}>
